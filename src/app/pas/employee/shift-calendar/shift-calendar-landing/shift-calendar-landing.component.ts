...
export class ShiftCalendarLandingComponent implements OnInit {
  ...
  columnDefs = [
    {
      ...
      valueFormatter: (params) =>
        this.agGridService.dateFormatter(params.data.startTime),
    },
    {
      field: "endTime",
      headerName: "WEEK END",
      ...
      filter: "agDateColumnFilter",
      valueFormatter: (params) =>
        this.agGridService.dateFormatter(params.data.endTime),
    },
    {
      field: "totalShift",
  ...
  ngOnInit(): void {
   ...
   /*  this.shiftCalendarList$.pipe(take(2)).subscribe((data) => {
    ...
    this.http.get("assets/data/shift.json").subscribe(data =>{
