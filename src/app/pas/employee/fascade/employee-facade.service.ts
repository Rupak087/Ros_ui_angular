  ...
  editEmployee(e: any) {
    this.employeeService
      ...
      .subscribe(
        (e) => {
          console.log(e);
          for (let i = 0; i < this.dataStore.allEmployee.length; i++) {
            if (this.dataStore.allEmployee[i].id === e.employeeId) {
              this.dataStore.allEmployee[i] = e;
              console.log("editEmployee data", this.dataStore.allEmployee[i]);
            }
          }
          console.log("datastore", this.dataStore.allEmployee);
          this.employeeListSubject.next(
            Object.assign({}, this.dataStore).allEmployee
          );
        },
