...
import { leavesFacadeService } from '../fascade/leaves-facade.service';
...
export class LeavesComponent implements OnInit {
 ...
 leaveslist$=this.leavesFacade.leavesList$
 private readonly destroy$=new Subject<void>()
  ...
  people;
  constructor( private leavesFacade:leavesFacadeService, private modalService: NgbModal, private dialogService: NbDialogService,private router: Router) { }
  open(b) {
    this.people = b;
 ...
 leavelist
  ngOnInit(): void {
    this.leaveslist$.pipe(takeUntil(this.destroy$)).subscribe((data) => {
      this.leavelist = Object.assign([], data);
      console.log("Leaves", this.leavelist);
      console.log("leaves List is updated");
    });

  }
leavesfun(){
  this.getLeavesdata=this.leavesFacade.getLeaves()
   console.log(this.getLeavesdata)
}

deletefun(){
  this.deleteLeavesdata=this.leavesFacade.deleteleaves(this.id)
   console.log(this.deleteLeavesdata)
}
editfun(){
  this.editleavesdata=this.leavesFacade.editleaves(this.start,this.id)
   console.log(this.editleavesdata)
}
