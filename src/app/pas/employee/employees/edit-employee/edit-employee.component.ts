...
export class EditEmployeeComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.loadData();
     this.empFormGroup = this.fb.group({
      joiningInfo: [
        this.allEmployee?.joiningDate,
        [Validators.required],
      ],
      // profileimg: [this.empobj.basicInfo.empDetails.empImgUrl.value,[]],
      firstname: [
        this.allEmployee?.firstName,
        [Validators.required],
      ],
      middlename: [this.allEmployee.middleName],
      lastname: [
        this.allEmployee?.lastName,
        [Validators.required],
      ],
      city: [
        this.allEmployee?.city,
        [Validators.required],
      ],
      state: [
    ...
    console.log("empformgrp",this.empFormGroup)
  ...
  submitEmpForm(form) {
    ...
    console.log("employee form",form.value);
    let newEmp = {
      id: this.empid,
    ...
    console.log(newEmp);
    this.employeeFacade.editEmployee(newEmp);
